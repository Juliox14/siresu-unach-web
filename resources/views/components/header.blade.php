<header id="main-header" x-data="{
    ...
    class="bg-[#001B3A] text-white font-sans fixed top-0 left-0 w-full z-50
    ...
    <div
        ...
        <div class="flex items-center space-x-4">
            <a href="https://www.facebook.com/OficialSIRESU" target="_blank" class="hover:text-yellow-500 transition">
                <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
                    <path
                        d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
            </a>
            <a href="https://www.instagram.com/siresu_unach/" target="_blank" class="hover:text-yellow-500 transition">
                <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
                    <path
                        d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
            </a>
            <a href="https://x.com/SIRESUNACH" target="_blank" class="hover:text-yellow-500 transition">
                <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
                    <path
    ...
    <nav class="container mx-auto px-4 py-4">
        <ul
            ...
            <li><a href="{{ route('acerca-de') }}"
                    class="hover:text-yellow-400 transition pb-1 border-b-2 border-transparent hover:border-yellow-400">Acerca
                    de</a></li>
            ...
            <li x-data="{ openDepto: false }" class="relative" @mouseenter="openDepto = true" @mouseleave="openDepto = false">
                ...
                <div x-show="openDepto" style="display: none;" x-transition:enter="transition ease-out duration-200"
                    ...
                    class="absolute left-1/2 transform rounded-md -translate-x-1/2 mt-2 w-64 bg-gray-200 shadow-xl z-50 overflow-hidden text-left">
