...
<div x-show="open" x-effect="document.body.classList.toggle('overflow-hidden', open); $dispatch(open ? 'modal-abierto' : 'modal-cerrado')"
        ...
        <div class="relative inline-block align-bottom bg-white rounded-xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full"
            ...
            <div class="relative h-48 md:h-64">
                ...
                <div class="absolute bottom-4 left-6 text-white pr-4">
                    <p
                        class="text-xs font-bold bg-[#EAB308] text-[#001B3A] px-2 py-1 rounded w-fit mb-2 uppercase tracking-wide">
                        {{ $evento->categoria }}
                    </p>
            ...
            <div class="px-6 py-6 md:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
                    ...
                    <div class="md:col-span-2 space-y-6">
                        ...
                        <div class="flex items-start text-gray-700">
                            <div
                                class="bg-blue-50 p-2 rounded-lg mr-4 shrink-0 text-center min-w-14 flex items-center justify-center">
                    ...
                    <div class="md:col-span-1 space-y-6">
                        ...
                        @if (!empty($evento->mapa_iframe))
                            <div>
                                ...
                                <div
                                    class="rounded-lg overflow-hidden shadow-sm border border-gray-200 h-40 w-full bg-gray-50">
                                ...
                                <a href="https://maps.google.com/?q={{ urlencode($evento->direccion . ' ' . $evento->ciudad) }}"
                                    target="_blank"
                                    class="inline-flex items-center text-xs text-blue-600 mt-2 hover:underline">
                            ...
                            @if ($evento->link_inscripcion)
                                <div class="mt-6 border-t border-gray-100 pt-6">
                                    <a href="{{ $evento->link_inscripcion }}" target="_blank"
                                        class="group flex items-center justify-center w-full px-4 py-2 border border-transparent text-sm font-medium rounded-md bg-[#EAB308] hover:bg-yellow-500 transition-all shadow-sm">
                                        <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        <span class="text-[#001B3A]">Confirmar Asistencia</span>
                                    </a>
                                    <p class="text-xs text-gray-500 mt-2 text-center md:text-left">Serás redirigido a un
                                        formulario de registro externo.</p>
                                </div>
                            @endif
                        </div>
                ...
                <div class="flex justify-between items-center pt-6 border-t border-gray-100">
                    <div class="flex flex-col space-x-4">
                        <p class="text-xs text-gray-500 mb-4">Revisa nuestra publicación sobre este evento en nuestras
                            redes
                            sociales.</p>
