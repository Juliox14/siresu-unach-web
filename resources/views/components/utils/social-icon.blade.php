@props(['name', 'class' => 'w-5 h-5 fill-current'])

@php
    // Limpiamos el nombre: quitamos espacios y lo hacemos minúsculas
    $social = strtolower(trim($name));
@endphp
...
@switch($social)
    ...
    @case('tiktok')
        <svg class="{{ $class }}" viewBox="0 0 448 512" fill="currentColor">
